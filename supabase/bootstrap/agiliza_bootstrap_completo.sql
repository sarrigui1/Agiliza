...
-- Concatenación de supabase/migrations/*.sql en orden, generada automáticamente por
-- scripts/generar-bootstrap-sql.sh.
-- NO editar este archivo a mano — para cambios, edita las migraciones individuales en
-- supabase/migrations/ y vuelve a correr ese script (ver docs/MANUAL_INSTALACION_IMPLEMENTACION.md,
-- sección 4).
--
-- Uso: pega el contenido completo de este archivo UNA SOLA VEZ en el SQL Editor de un
-- proyecto Supabase nuevo. Reemplaza correr las migraciones una por una.
-- =====================================================================================
...
-- ------------------------------------------------------------------------------------
-- Origen: supabase/migrations/0018_habeas_data.sql
-- ------------------------------------------------------------------------------------
-- =====================================================================================
...
-- ------------------------------------------------------------------------------------
-- Origen: supabase/migrations/0019_whatsapp_notificaciones.sql
-- ------------------------------------------------------------------------------------
-- =====================================================================================
